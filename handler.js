...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *Siuu*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *Siuu*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *Siuu*.`,
